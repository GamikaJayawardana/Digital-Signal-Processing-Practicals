...
% Design Chebyshev Type II low-pass
[b, a] = cheby2(N, alphas, Wn, 'low');
...
ylabel('Gain in dB');
title('Chebyshev Type II Low-pass Filter Frequency Response');
grid on;
...
title('Chebyshev Type II Low-pass Filter Phase Response');
grid on;
