...
b_rectangle = fir1(N, f/pi, 'low', rectwin(N+1)); 
b_blackman = fir1(N, f/pi, 'low', blackman(N+1));
b_hamming = fir1(N, f/pi, 'low', hamming(N+1));
b_hanning = fir1(N, f/pi, 'low', hann(N+1));
b_triangular = fir1(N, f/pi, 'low', triang(N+1)); 
...
sgtitle('Low-Pass Filters using Different Windows');
